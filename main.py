...
df_notimecollumn = pd.read_csv("data/INMET_CO_DF_A001_BRASILIA_01-01-2023_A_31-12-2023.CSV", encoding="utf-8", decimal=",", sep=";", converters={'Data': str, 'Hora UTC': str})

#mudando tipo para string
df_notimecollumn[['Data', 'Hora UTC']] = df_notimecollumn[['Data', 'Hora UTC']].astype("string")

df_notimecollumn = df_notimecollumn.drop(columns=['Hora UTC', 'Unnamed: 19'])


column_name = 'TEMPERATURA DO AR - BULBO SECO, HORARIA (GRAUS CELSIUS)'
